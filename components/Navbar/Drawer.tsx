...
const Drawer = () => {
  ...
  return (
    <div className=" z-50 fixed flex md:hidden">
      ...
      {isDrawerOpen && (
        <div className="absolute top-0 h-screen z-50 w-fit p-4 bg-black shadow-lg rounded-md">
          <button
          ...
          >
            <li className="hover:underline hover:text-lg font-[Itim] font-light ease-in-out">
            ...
            <li>
              <Link
                href={"#Footer"}
                className="hover:underline hover:text-lg font-[Itim] font-light ease-in-out"
              >
                Contact
              </Link>
            </li>
