    ...
    <div id="About" className="flex flex-row bg-secondaryblack">
      <div className="md:w-2/3 my-20 flex flex-col ">
        <div className="md:flex md:justify-center md:items-center md:mb-16">
          ...
          <h1 className="uppercase sm: font-['Encode Sans SC'] mx-5 text-5xl first-letter:text-6xl">
            About Me
          </h1>
        </div>
        <div className="flex">
        ...
        <button className="font-['Inder'] font-medium bg-button py-3 px-5 text-xl rounded-2xl mx-20 md:my-10 inline-flex w-fit">
          Learn More {`>`}{" "}
        </button>
        <Starcollection
          width={60}
      ...
      <div className="specialdiv2 h-screen md:w-1/3 bg-darkblack"></div>
    </div>
  );
};
